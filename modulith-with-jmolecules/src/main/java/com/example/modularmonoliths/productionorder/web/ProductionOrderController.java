...
public class ProductionOrderController implements RepresentationModelProcessor<EntityModel<ProductionOrder>> {
    ...
    public ResponseEntity<?> rename(@PathVariable ProductionOrderIdentifier id, @RequestBody RenameRequest request) {
    ...
    public ResponseEntity<?> submit(@PathVariable ProductionOrderIdentifier id) {
        return productionOrders.findById(id)
    ...
    public ResponseEntity<?> accept(@PathVariable ProductionOrderIdentifier id, @RequestBody AcceptRequest request) {
        return productionOrders.findById(id)
    ...
    public ResponseEntity<?> complete(@PathVariable ProductionOrderIdentifier id) {
        return productionOrders.findById(id)
